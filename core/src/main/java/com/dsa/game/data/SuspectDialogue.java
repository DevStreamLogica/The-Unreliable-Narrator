...
public class SuspectDialogue {
    ...
    private static void initResponses() {
        ...
        RESPONSES.put("MARGARET_inheritance", "\"I didn't know about the will changes until Charles told me the day after Father died.\" She looked away. \"Charles said I was inheriting everything now. I thought it was strange. I didn't realize until later...\" Her voice broke. \"I didn't realize James had already killed him to prevent those changes from being signed.\"");
        ...
        RESPONSES.put("CHARLES_company", "\"The lawsuit with Blackwood Industries was consuming Mr. Vance. Two million pounds at stake.\" Charles shook his head. \"And something else was troubling him -- he kept reviewing the company books late at night. He seemed... devastated about something.\"");
    }
    ...
    private static void initFalseResponses() {
        ...
        FALSE_RESPONSES.put("JAMES_whereabouts", "\"I already told you -- I was with Margaret all evening. We were in the parlor playing cards until midnight. Ask her.\" Margaret said no such thing.");
