...
public enum Contradiction {
    ...
    BODY_POSITION("Harold was moved after death. The blood pooling pattern shows he died in the study, but the body was found in the cellar. It took two people to move him -- James and Daniel working together after 11:00 PM, once the household was asleep."),
    ...
    NARRATOR_TIME("The narrator claimed Harold died after midnight, but Charles saw James heading to the study at 10:45 PM -- and Marcus heard the argument, then silence, before driving away at 11:00 PM. The murder happened between 10:45 and 11:00 PM, not after midnight.");
