...
public enum Evidence {
    ...
    TORN_LETTER("Torn Letter", "A partially burned letter from the study fireplace. Someone knew what James was doing and tried to warn Harold before the will was signed."),
    ...
    SLEEPING_POWDER("Sleeping Powder", "A vial of sleeping powder discovered in the cellar. Someone was planning to drug Harold."),
    ...
    BLACKMAIL_NOTE("Blackmail Note", "A blackmail note with rough handwriting, planted in Margaret's room. The handwriting is deliberately crude and uneducated. Someone planted this to frame Margaret and make her look suspicious. It was never a real blackmail note."),
